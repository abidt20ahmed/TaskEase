        ...
        <DynamicModal isOpen={isOpen}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end">
                    <button onClick={() => setTask && setTask({ ...task, priority: priority || task?.priority || 'Low' })} type="submit" className="px-4 py-2  bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br text-white rounded-md mr-2">Save</button>
